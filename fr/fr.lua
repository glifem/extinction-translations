...
^2Si vous voulez obtenir un prestige et RECOMMENCER level 0 tapez ^1/setprestige^2
	...
	dungeon_find_keycard_obj = "Trouvez une carte-clé pour ouvrir la porte de la pièce.",
	...
	max_deluxo_squad_size_reached = "~r~Votre escouqde doit être limitée à deux membres dans l'arène Deluxo.",
	...
	purged_ended_x_survivor = "Cette purge terminée, vous étiez le ~r~#%s survivant~w~.",
