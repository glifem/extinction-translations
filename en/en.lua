...
^2If you want to get a prestige and RETURN level 0 type ^1/setprestige^2
	...
	tutorial_looting_zombie = "Killing ^1zombies^7 is a simple way to get weapons, vehicles or other items. This is the simplest and easiest way to get loot. You can either store what you collect or sell it to any NPC in the safezones.",
	...
	mission_or = "or",
	mission_and = "and",
	mission_kill_player_simple = "Kill %s players",
	mission_kill_player_weapon = "Kill %s players using %s",
	mission_zombie_kill_simple = "Kill %s zombies",
	mission_zombie_kill_weapon = "Kill %s zombies using %s",
	mission_zombie_armored_kill_simple = "Kill %s armored zombies",
	mission_zombie_armored_kill_weapon = "Kill %s armored zombies using %s",
	mission_zombie_boomer_kill_simple = "Kill %s boomer zombies",
	mission_zombie_boomer_kill_weapon = "Kill %s boomer zombies using %s",
	mission_zombie_hazmat_kill_simple = "Kill %s hazmat zombies",
	mission_zombie_hazmat_kill_weapon = "Kill %s hazmat zombies using %s",
	mission_zombie_survivor_kill_simple = "Kill %s survivor zombies",
	mission_zombie_survivor_kill_weapon = "Kill %s survivor zombies using %s",
	mission_kill_darkzone_player_simple = "Kill %s players in the darkzone",
	mission_kill_darkzone_player_weapon = "Kill %s players in the darkzone using %s",
	mission_kill_darkzone_zombie_simple = "Kill %s zombies in the darkzone",
	mission_kill_darkzone_zombie_weapon = "Kill %s zombies in the darkzone using %s",
	mission_kill_headshot_simple = "Kill %s players with a headshot",
	mission_kill_headshot_weapon = "Kill %s players with a headshot using %s",
	mission_kill_headshot_zombie_simple = "Kill %s zombies with a headshot",
	mission_kill_headshot_zombie_weapon = "Kill %s zombies with a headshot using %s",
	mission_kill_player_arena_simple = "Kill %s players in the deluxo arena",
	mission_kill_player_arena_weapon = "Kill %s players in the deluxo arena using %s",
	mission_destroy_vehicle_arena = "Destroy %s vehicles in the deluxo arena",
	mission_kill_player_gungame_simple = "Kill %s players in gungame",
	mission_kill_player_gungame_weapon = "Kill %s players in gungame using %s",
	mission_play_gungame = "Play %s games of gungame",
	mission_darkzone_survive_time = "Survive %s minutes in the darkzone",
	mission_loot_items_simple = "Loot %s items",
	mission_loot_items_category = "Loot %s items from this category (%s)",
	mission_loot_items_building_simple = "Loot %s items from buildings",
	mission_loot_items_building_category = "Loot %s items from buildings from this category (%s)",
	mission_sell_offer_simple = "Sell %s items to the marketplace",
	mission_sell_offer_category = "Sell %s items to the marketplace from this category (%s)",
	mission_sell_offer_me_simple = "Purchase %s items from the marketplace",
	mission_sell_offer_me_category = "Purchase %s items from the marketplace from this category (%s)",
	mission_purge_fight_kill_player_simple = "Kill %s players in the purge fight",
	mission_purge_fight_kill_player_weapon = "Kill %s players in the purge fight using %s",
	mission_airdrop_kill_simple = "Kill %s players in the airdrop",
	mission_airdrop_kill_weapon = "Kill %s players in the airdrop using %s",
	mission_cargoship_kill_simple = "Kill %s players in the cargo ship",
	mission_cargoship_kill_weapon = "Kill %s players in the cargo ship using %s",
	mission_quest_complete_simple = "Complete %s quests",
	mission_duel_kill_player = "Kill %s players in a duel",
	mission_duel_kill_player_weapon = "Kill %s players in a duel using %s",
	mission_avenger_kill_player = "Kill %s players during the Avenger event",
	mission_avenger_kill_player_weapon = "Kill %s players during the Avenger event using %s",
	mission_duel_win = "Win %s duels",
	mission_kill_top_player_simple = "Kill %s players from any top 100 leaderboard",
	mission_kill_top_player_weapon = "Kill %s players from any top 100 leaderboard using %s",
	mission_kill_top_crew_simple = "Kill %s players from any top 100 crew leaderboard",
	mission_kill_top_crew_weapon = "Kill %s players from any top 100 crew leaderboard using %s",
	mission_loot_items_player_simple = "Loot %s items from players",
	mission_loot_items_player_category = "Loot %s items from players from this category (%s)",
	mission_win_gungame = "Win %s games of gungame",
	mission_win_purge_fight = "Win %s games of purge fight",
	mission_br_played = "Play %s games of Battle Royale",
	mission_dungeon_boss_kill = "Finish %s dungeons by killing the Boss",
	mission_play_time = "Play for %s minutes",
	mission_loot_crate_simple = "Open %s loot crates",
	mission_sell_items_simple = "Sell %s items to any NPC shop",
	mission_sell_items_category = "Sell %s items to any NPC shop from this category (%s)",
	mission_buy_items_simple = "Buy %s items from any NPC shop",
	mission_buy_items_category = "Buy %s items from any NPC shop from this category (%s)",
	category_all = "All",
